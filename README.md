...
### 🔍 [incident-summarizer](https://github.com/Avijit-07/incident-summarizer)
An AI-powered service that ingests raw incident data (alerts, logs, PagerDuty events) and generates structured RCA summaries using the Anthropic Claude API. Built in Java 25 + Spring Boot 4, with adapters for multiple input formats and a Discord webhook integration for posting summaries directly to your ops channel.

`Java` `Spring Boot` `Claude API` `REST` `Docker` `Gradle`
...
When I'm not writing Java or debugging OTel layer incompatibilities: Travelling, Photography and now trying to set up my house after heavily influenced from some random IG reels.
